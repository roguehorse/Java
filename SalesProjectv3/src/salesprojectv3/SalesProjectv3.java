...
public class SalesProjectv3 
{
    ...
    {
        Scanner input = new Scanner ( System.in );//Call scanner into variable input
        
        //Create variable salary and assign new object Base from class Base
        Basev3 salary = new Basev3();
        ...
        //Calculate gross from sales value x 7% + base of $75,000       
        gross2 = (Double)(sales * (salary.pIncentive() + salary.goalAccel()) + salary.baseSalary());
        //Calculate gross from sales value x 7% + base of $75,000       
        //gross2 = (Double)(sales * (salary.pIncentive() + .015) + salary.baseSalary());
        ...
        while (table <= sales * salary.tLength()) 
        {
            ...
            if (table >= salary.salesGoal()) //Determine if table variable is greater than $120,000
            {
                ...
                gross2 = (Double)(table * (salary.pIncentive() + salary.goalAccel()) + salary.baseSalary());
